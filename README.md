...
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| 🥋 **[The Social Dojo](https://github.com/your-username/the-social-dojo-repo)** | An AI-powered "flight simulator" for social skills, where users practice high-stakes conversations with dynamic, stateful AI characters. | **Currently Building.** Focusing on React component architecture, state management with `useState`, and translating a complex Figma design into a functional MVP. |
| 🎮 **[GamerGrave](https://github.com/sagehawk/grave-diggers-arcade-finds)**          | A full-stack game discovery platform built to explore data fetching and client-side filtering. | **Completed.** Learned a great deal about integrating with a BaaS (Supabase) and building a performant, responsive UI. |
| 🔤 **[Simple Phonics](https://github.com/sagehawk/phonics-fun-sparkle-time)**         | An interactive learning app designed to solve complex UI/UX challenges.    | **Completed.** Taught me valuable lessons in handling mobile gestures and architecting for accessibility (including RTL language support).    |
